...
- [ ] I kept the change scoped to BCX's existing architecture.
- [ ] I updated docs or release notes when behavior changed.
...
Describe any security-sensitive impact. Mention canonical encoding, signatures,
capabilities, replay handling, receipts, WHY traversal, transport bindings, or
